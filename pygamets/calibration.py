...
"""
PY_VERSION_ABOVE_3_12 = False
import sys
if sys.version_info >= (3, 12):
        PY_VERSION_ABOVE_3_12 = True

#import os, math, imp
import os, math
if PY_VERSION_ABOVE_3_12:
  import importlib
else:
  import imp
...
def load():
        ...
        if PY_VERSION_ABOVE_3_12:
                pp = os.path.join( config_dir(), config_file ) + '.py'
                loader = importlib.machinery.SourceFileLoader( config_file, pp )
