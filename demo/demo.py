...
import time, threading, functools, random, math, logging
...
class Demo(object):
        ...
        def run(self):
                ...
                print()
                print( 'pygamets demo application' )
                app.init()
...
#                        pygame.mouse.set_visible(False)
                ...
                print( '\tYour display driver is:     ', driver )
                print()

                if not (platform == 'win32' or driver == 'x11'):
                  pygame.mouse.set_visible( False )
